...
\terminwykonania{8 czerwca 2020} % data na oświadczeniu o samodzielności
\rok{2020}
...
\kierunekstudiow{Elektrotechnika}
\specjalnosc{Automatyka Przemysłowa}
...
\glsxtrnewsymbol[description={funkcja wagi, liczbowa reprezentacja podobieństwa punktów $x,y$ obrazu $I$}]{weight}{$w(x,y)$}
...
\glsxtrnewsymbol[description={długość boków tworzonych skrawków wokół piksela $x$}]{pixradius}{$|p_x|_r, |s_x|_r$}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.7]{rysunki/1_fig1.png}
\end{figure}
\\
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.5]{rysunki/6_fig1}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.6]{rysunki/6_fig2}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.8]{rysunki/4_fig1}
...
\begin{longtable}[h!]{|c|c|}
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=6cm]{imgmask/kotmyszm}
    \vspace{0.2cm}
    \end{minipage}
    &
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=6cm]{imgmask/maciek1m}
    \vspace{0.2cm}
    \end{minipage}
    &
    \begin{minipage}{.35\textwidth}
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=5.4cm]{imgmask/Obr1m}
    \vspace{0.2cm}
    \end{minipage}
    &
    \begin{minipage}{.35\textwidth}
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=7.5cm]{imgmask/Obr19m}
    \vspace{0.2cm}
    \end{minipage}
    &
    \begin{minipage}{.35\textwidth}
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=6.5cm]{imgmask/Obr28km}
    \vspace{0.2cm}
    \end{minipage}
    &
    \begin{minipage}{.35\textwidth}
...
\begin{longtable}[h!]{|c|c|}
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=5.5cm]{TESTY/NavierStokes/{Obr4m.pngITER_10000dt_0.015h_3pr_2tns_2021.6256}.png}
    \vspace{0.2cm}
    \end{minipage}
    &
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=7cm]{TESTY/NavierStokes/{Obr17m.pngITER_10000dt_0.015h_3pr_2tns_3225.3982}.png}
    \vspace{0.2cm}
    \end{minipage}
    &
    \begin{minipage}{.3\textwidth}
...
\begin{longtable}[h!]{|c|c|}
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=5.4cm]{TESTY/SOR/{SOR}.png}
    \vspace{0.2cm}
    \end{minipage}
    &
    \begin{minipage}{.3\textwidth}
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=5.4cm]{TESTY/SOR/{SORITER_1h_1}.png}
    \vspace{0.2cm}
    \end{minipage} 
    &
    \begin{minipage}{.3\textwidth}
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=5.4cm]{TESTY/SOR/{SORITER_1h_10}.png}
    \vspace{0.2cm}
    \end{minipage}
    &
    \begin{minipage}{.3\textwidth}
...
\begin{longtable}[h!]{|c|c|}
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=6.5cm]{TESTY/SALCRIM2004/SALIENT/{5_9_Obr6m}.png}
    \vspace{0.2cm}
    \end{minipage}
    &
    \begin{minipage}{.35\textwidth}
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=5.2cm]{TESTY/SALCRIM2004/SALIENT/{4_8_Obr13m}.png}
    \vspace{0.2cm}
    \end{minipage}
    &
    \begin{minipage}{.35\textwidth}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.55]{rysunki/SalientPatch.png}
...
\begin{longtable}[h!]{| c | c |}
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=5.1cm]{TESTY/NLCTVNLH1/IM/bar}
    \vspace{0.2cm}
    \end{minipage}
    &
    \begin{minipage}{.35\textwidth}
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=4.7cm]{TESTY/NLCTVNLH1/IM/TEST}
    \vspace{0.2cm}
    \end{minipage}
    &
    \begin{minipage}{.35\textwidth}
...
\begin{longtable}[h!]{|c|c|}
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=6cm]{{TESTY/NLCTVORIG/Adds/Obr17m.pngs_r_25p_r10h_5sw_3t_12766.7184}.png}
    \vspace{0.2cm}
    \end{minipage}
	&
    \begin{minipage}{0.5\textwidth}
    \vspace{0.2cm}
    \centering
    \includegraphics[height=6cm]{{TESTY/NLCTVORIG/Adds/Obr17m.pngs_r_25p_r10h_5sw_1t_2299.7753}.png}
    \vspace{0.2cm}
    \end{minipage}\\ \hline
...
\end{tabular}
\caption{Czas [s] wmalowywania z wykorzystaniem wymienionych metod.}
...
\begin{longtable}[h!]{|c|c|}
    ...
    \vspace{0.2cm}
    \centering
    \includegraphics[height=4.5cm]{TESTY/SNRT/VF/SNR2m.png_nlmedians_sc4_0.342105_initnone_ps13_10000_conf5_0.1_t179.196.png}
    \vspace{0.2cm}
    \end{minipage}
	&
    \begin{minipage}{0.5\textwidth}
