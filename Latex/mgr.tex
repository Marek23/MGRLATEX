...
\begin{longtable}[h!]{|c|c|}
  ...
  \caption{Wyniki metody Criminisi.}\label{CRIMTEST}
\end{longtable}
...
\end{longtable}
Wyznaczenie głównych struktur w każdym z testowych obrazów nie wymagało czasu obliczeniowego większego niż $1s$. W uproszeniu można przyjąć, algorytm pozwala oszczędzić czas potrzebny na proces wmalowywania równy procentowi wyznaczonej maski z całkowitego czasu oryginalnej metody Criminisi. Ostatecznie przykładowe wyniki określa tabela:
...
-wprowadzenie stref martwych w obrazie -> przez użytkownika -> wartości, które maja się nie pojawić w masce
-napisać o korekcji fotometrycznej do crim

CRIM: mniejsza większa wartość nie wpływa na wadę obrazu w postaci nieprawidłowego elementu
-samo ograniczenie search window nie pomaga, ale może bo sąsiad wcale nie musi być najlepszym

koniecznie dodać banana- tam salient structure dobrze zadziałało. Łódka też. dopasowaniem.

przy salient structure rozmiar dobrany do konkretnego przypadku
