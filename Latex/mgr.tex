...
\subsubsection{Modyfikacja wyznaczania wartości obrazu.}
Złożoność obliczeniowa algorytmu skutkuje w względnie długim czasie wypełniania obrazu. W celu skrócenia czasu wyznaczania wynikowego obrazu zastosowano następującą aproksymację pozwalającą uzyskać przybliżone wyniki do oryginalnego algorytmu:
