...
\glsxtrnewsymbol[description={prędkość lokalna płynu}]{V}{$V$}
\glsxtrnewsymbol[description={gęstość lokalna płynu}]{q}{$q$}
\glsxtrnewsymbol[description={ciśnienie płynu}]{p}{$p$}
\glsxtrnewsymbol[description={siła lokalna działająca na płyn}]{F}{$F$}
\glsxtrnewsymbol[description={lepkość kinematyczna}]{Ni}{$\nu$}
\glsxtrnewsymbol[description={linia prądu będącą ciągłą linią w polu prędkości płynu}]{Psi}{$\Psi$}
\glsxtrnewsymbol[description={wirowość płynu}]{omega}{$\omega$}
\glsxtrnewsymbol[description={współczynnik dyfuzji anizotropowej}]{g}{$g$}
\glsxtrnewsymbol[description={parametry, reprezentacja parametryzowanej liczby rzeczywistej}]{wsp}{$\alpha, \beta$}
\glsxtrnewsymbol[description={wartość piksela obrazu $I$ w punkcie o współrzędnych $i ,j$}]{Iij}{$I_{i,j}$}
...
\glsxtrnewsymbol[description={pochodna cząstkowa funkcji wielu zmiennych $f$ względem zmiennej $x$}]{frac}{$\frac{\partial f}{\partial x},\partial{f}_x$}
