...
Przykłądy obrazów poddanych segmentacji przedstawia \autoref{TabSegmentation}.
\begin{longtable}[h!]{|c|c|}
    \hline
    \multicolumn{2}{|c|}{
    	Segmentacja obrazu
...
\begin{longtable}[h!]{|c|c|}
    ...
    \vspace{0.5cm}
    \end{minipage}\\ \hline
	\caption{Porównanie wyników uzyskanych metodą rozwiązania równania Navier'a-Stokes'a do metody oddzielnej syntezy tekstury.}
...
Segmentacja tekstury przy rozmytej strukturze nic nie da.
...
Do syntezy tekstury lekko wyniki poprawiłaby metoda Criminisi... Info, że można zastosować

zwykły schemat nadaje się do mega
