...
\end{enumerate}
\tekxtbf{W niniejszej pracy opisano przedstawione wcześniej algorytmy, przetestowano i opisano dobór ich optymalnych parametrów, porównano oraz zaproponowano nowe modele uzupełniania brakujących danych}.
