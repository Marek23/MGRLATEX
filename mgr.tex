...
\glsxtrnewsymbol[description={parametr, liczba rzeczywista}]{wsp2}{$\varepsilon, r, p_s, r, Z$}
...
\glsxtrnewsymbol[description={podmacierz obrazu $I$ utworzonych z punktów będących otoczeniem punktu $x$}]{surround}{$I(x+\cdot)$}
...
\glsxtrnewsymbol[description={reprezentacja funkcji będącej nielokalnym przekształceniem $D \times D \rightarrow R$}]{nlreop}{$p_1$}
