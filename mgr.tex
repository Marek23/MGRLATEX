...
\glsxtrnewsymbol[description={parametr, liczba rzeczywista}]{wsp}{$\alpha, \beta, \lambda, \mu$}
...
\glsxtrnewsymbol[description={zbiór funkcji kwadratowo całkowalnych}]{squareint}{$I\in L^2(R^2)$}
...
\begin{align}
\begin{aligned}
u^{n+1}\big|_{i,j} &= \left[\frac{1}{1 + {\frac{1}{2\lambda h^2}\right)\cdot \left(c_1\big|_{(i,j}+c_2\big|_{i,j}+c_3\big|_{i,j}+c_4\big|_{i,j}\right)}\right]\bigcdot \\ 
