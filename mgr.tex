...
\begin{table}[!h]
\begin{center}
 \begin{tabular}{| p{5.5cm} || P{1.5cm} | P{1.5cm} | P{1.5cm} | P{1.5cm} |} 
 \hline
Skrót nazwy metody (dział) & Obraz 1 & Obraz 2 & Obraz 3 & Obraz 4 \\ \hline \hline

NS (\ref{sec:snavierstokes}) &
0.1234 & 0.1234 & 0.1234 & 0.1234 \\ \hline

NS ST (\ref{sec:StructureTextureNavierStokes}) &
0.4571 & 0.5604 & 0.4092 & 0.1502 \\ \hline

Crim (\ref{sec:crimMetod}) &
0.4363 & 0.5292 & 0.4244 & 0.7188 \\ \hline

Sal Crim (\ref{sec:crimMetodSalient}) &
0.5572 & 0.5247 & 0.4437 & 0.6939 \\ \hline

NLCTV (\ref{sec:sNLCTV}) &
0.5807 & 0.6841 & 0.5461 & 0.3119 \\ \hline

NLCTV MOD (\ref{sec:smodNLCTV}) &
0.5512 & 0.6560 & 0.5129 & 0.5571 \\ \hline

VF (\ref{sec:sVFI}) &
0.6222 & 0.5964 & 0.5717 & 0.5730 \\ \hline
...
\centering
 ...
 \hline
Metoda z działu &
NV     & ST NS   & Crim  & Sal Crim & NLCTV   & NLCTV MOD & VF \\ [0.5ex] \hline

z działu &
\ref{sec:snavierstokes} &
\ref{sec:StructureTextureNavierStokes} &
\ref{sec:crimMetod} &
\ref{sec:crimMetodSalient} &
\ref{sec:sNLCTV} &
\ref{sec:smodNLCTV} &
\ref{sec:sVFI} \\ [0.5ex] \hline \hline
Obraz 1  &
