...
Zdanie do przeniesienia
Jedną z niedogodności metody jest konieczność stosowania metody korekcji fotometrycznej zgodnie z \cite{StructurePropagationManual}, wygładzającej lokalne granice obrazu powstałe w wyniku syntezy fragmentów obrazu $q_{\hat{x}}$ w wyznaczanym obszarze $\mathrm{\Omega }$.
\end{comment}